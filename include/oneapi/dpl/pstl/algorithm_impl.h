                     ...
                     /*parallel=*/::std::true_type)
{
    ...
    __internal::__except_handler(
        ...
        {
            __par_backend::__parallel_for(::std::forward<_ExecutionPolicy>(__exec), __first, __last,
                                          [__brick, __is_vector](_ForwardIterator __i, _ForwardIterator __j)
    ...
    return __internal::__except_handler(
        [&]()
        {
            __par_backend::__parallel_for(::std::forward<_ExecutionPolicy>(__exec), __first1, __last1,
                                          [__f, __first1, __first2, __first3, __is_vector](_RandomAccessIterator1 __i,
                                                                                           _RandomAccessIterator1 __j) {
                                              __internal::__brick_walk3(__i, __j, __first2 + (__i - __first1),
                                                                        __first3 + (__i - __first1), __f, __is_vector);
                                          });
                   ...
                   /*is_parallel=*/::std::true_type)
{
    ...
    {
        return __internal::__except_handler(
            [&__exec, __first, __last, __count, &__value, __pred, __is_vector]()
            {
                return __internal::__parallel_find(
                    ::std::forward<_ExecutionPolicy>(__exec), __first, __last,
                    [__last, __count, &__value, __pred, __is_vector](_RandomAccessIterator __i,
                  ...
                  /*parallel=*/::std::true_type)
{
    ...
    {
        __utils::__buffer<_ExecutionPolicy, bool> __mask_buf(__n);
        return __except_handler(
                  ...
                  _IsVector __is_vector)
{
    ...
    return __internal::__except_handler(
        [&]()
        {
            ...
            __utils::__buffer<_ExecutionPolicy, _Tp> __buf(__n);
                      ...
                      /*parallel=*/::std::true_type)
{
    ...
    if (_DifferenceType(2) < __n)
    {
        ...
        {
            return __internal::__except_handler(
                [&__exec, __n, __first, __result, __pred, __is_vector, &__mask_buf]()
                {
                    bool* __mask = __mask_buf.get();
                    _DifferenceType __m{};
                    __par_backend::__parallel_strict_scan(
                        ...
                        [=](_DifferenceType __i, _DifferenceType __len) -> _DifferenceType { // Reduce
                            ...
                            return __internal::__brick_calc_mask_2<_DifferenceType>(
                                       __first + __i, __first + (__i + __len), __mask + __i, __pred, __is_vector) +
                                   __extra;
                        },
                        ::std::plus<_DifferenceType>(),                                              // Combine
                        [=](_DifferenceType __i, _DifferenceType __len, _DifferenceType __initial) { // Scan
                 ...
                 _ForwardIterator __last, _IsVector __is_vector, /*is_parallel=*/::std::true_type)
{
    ...
    if (__m <= __n / 2)
    {
        __utils::__buffer<_ExecutionPolicy, _Tp> __buf(__n - __m);
        return __except_handler(
            [&__exec, __n, __m, __first, __middle, __last, __is_vector, &__buf]()
            {
                ...
                __par_backend::__parallel_for(
                    ...
                    { __brick_move<_ExecutionPolicy>{}(__b, __e, __b + (__last - __middle), __is_vector); });
    ...
    {
        __utils::__buffer<_ExecutionPolicy, _Tp> __buf(__m);
        return __except_handler(
            [&__exec, __n, __m, __first, __middle, __last, __is_vector, &__buf]()
            {
                _Tp* __result = __buf.get();
                ...
                __par_backend::__parallel_for(
                    ...
                    { __brick_move<_ExecutionPolicy>{}(__b, __e, __first + (__b - __middle), __is_vector); });
                ...
                __par_backend::__parallel_for(::std::forward<_ExecutionPolicy>(__exec), __result, __result + __m,
                                              [__n, __m, __first, __result, __is_vector](_Tp* __b, _Tp* __e) {
                                                  __brick_move_destroy<_ExecutionPolicy>{}(
                                                      __b, __e, __first + ((__n - __m) + (__b - __result)),
                                                      __is_vector);
                                              });
                       ...
                       /*is_vector=*/::std::true_type) noexcept
{
    ...
    {
        _ForwardIterator __result = __unseq_backend::__simd_first(__first, _SizeType(0), __last - __first,
                    ...
                    __par_backend::__parallel_for(
                        ...
                        [__val1, __val2, __size1, __is_vector](_ForwardIterator __i, _ForwardIterator __j) {
                            __internal::__brick_swap_ranges(
                                __i, __j, (__val2.__pivot - __size1) + (__i - __val1.__pivot), __is_vector);
                        });
                ...
                else
                {
                    __par_backend::__parallel_for(
                        ...
                        [__val1, __val2, __is_vector](_ForwardIterator __i, _ForwardIterator __j) {
                            __internal::__brick_swap_ranges(__i, __j, __val2.__begin + (__i - __val1.__pivot),
                                                            __is_vector);
                        });
        ...
        [&]()
        {
            ...
            _PartitionRange __result = __par_backend::__parallel_reduce(
                                                   ...
                                                   _PartitionRange __value) -> _PartitionRange
                {
                    ...
                    _BidirectionalIterator __pivot =
                        __internal::__brick_stable_partition(__i, __j, __pred, __is_vector);
    ...
    return __internal::__except_handler(
        [&]()
        {
            ...
            else
            {
                ...
                __utils::__buffer<_ExecutionPolicy, _T1> __buf(__n1);
                _T1* __r = __buf.get();
                ...
                __par_backend::__parallel_for(::std::forward<_ExecutionPolicy>(__exec), __r + __n2, __r + __n1,
                  ...
                  _SizeFunction __size_func, _SetOP __set_op, _IsVector __is_vector)
{
    ...
    __utils::__buffer<_ExecutionPolicy, _T> __buf(__size_func(__n1, __n2));

    return __internal::__except_handler(
        [&__exec, __n1, __first1, __last1, __first2, __last2, __result, __is_vector, __comp, __size_func, __set_op,
         &__buf]()
        {
...
__brick_is_heap(_RandomAccessIterator __first, _RandomAccessIterator __last, _Compare __comp,
                /* __is_vector = */ ::std::true_type) noexcept
{
    return !__unseq_backend::__simd_or_iter(__first, __last - __first,
    ...
    return __internal::__except_handler(
        [&]()
        {
            return !__parallel_or(
                ::std::forward<_ExecutionPolicy>(__exec), __first, __last,
                [__first, __comp, __is_vector](_RandomAccessIterator __i, _RandomAccessIterator __j)
                { return !__internal::__is_heap_local(__first, __i - __first, __j - __first, __comp, __is_vector); });
        });
}
                    ...
                    _RandomAccessIterator __init) -> _RandomAccessIterator
                {
                    ...
                    return __init == __last ? __subresult
                                            : __internal::__cmp_iterators_by_values(
                                                  __init, __subresult, __comp, oneapi::dpl::__internal::__pstl_less());
                },
    ...
    return __internal::__except_handler(
        [&]()
        {
            ...
            auto __result = __internal::__parallel_find(
                ...
                {
                    return __internal::__brick_mismatch(__i, __j, __first2 + (__i - __first1),
                                ...
                                /* __is_vector = */ ::std::true_type) noexcept
{
    ...
    else
    {
        ...
        ::std::pair<_ForwardIterator1, _ForwardIterator2> __result =
            __unseq_backend::__simd_first(__first1, __n, __first2,
