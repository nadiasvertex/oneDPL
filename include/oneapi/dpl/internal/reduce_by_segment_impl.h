                       ...
                       BinaryOperator binary_op)
{
    ...
    oneapi::dpl::__utils::__buffer<policy_type, FlagType> _mask(n + 1);
    auto mask = _mask.get();
    mask[0] = 1;
    ...
    oneapi::dpl::__utils::__buffer<policy_type, FlagType> _scanned_values(n);
    ...
    oneapi::dpl::__utils::__buffer<policy_type, FlagType> _scanned_tail_flags(n);
